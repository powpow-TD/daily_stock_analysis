...
class Config:
    ...
    # Weekend review topic: weekly_validation (Saturday) / next_week_plan (Sunday).
    weekend_review_focus: str = ""
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            weekend_review_focus=os.getenv('WEEKEND_REVIEW_FOCUS', '').strip().lower(),
